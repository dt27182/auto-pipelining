...
# DVE full session
# Saved on Thu Nov 7 13:21:03 2013
# Designs open: 1
...
#<Session mode="Full" path="/home/eecs/wenyu/auto-pipelining/fsm-test/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{0 0} {1515 752}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 155} {height 485} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 247} {height 485} {dock_state left} {dock_on_new_line true} {child_data_colvariable 206} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 161]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1516
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 161
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1515} {height 160} {dock_state bottom} {dock_on_new_line true}}
